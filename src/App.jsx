...
function App() {
  const [basicSalary, setBasicSalary] = useState(17900); // Stage 4 selected by default
  const [daRatePercent, setDaRatePercent] = useState(50.12); // Initial DA rate in percentage
